...
def ensure_schema_compat(connection: MySQLConnection) -> None:
    ...
    if not _column_exists(connection, "experiment_runs", "reference_output"):
        cursor.execute(
            "ALTER TABLE experiment_runs ADD COLUMN reference_output MEDIUMTEXT NULL"
        )
    required_experiment_columns = {
        ...
        "reference_output": "MEDIUMTEXT NULL",
